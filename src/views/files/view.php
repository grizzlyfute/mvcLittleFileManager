...
?>
    ...
    {
      echo '<img src="' . $file_url . '" alt="" class="preview-img" style="overflow:scroll; aspect-ratio: 1; margin: auto; vertical-align: middle; max-width: 500%">' . PHP_EOL;
    }
    ...
    else
    {
      ...
      echo '  <a style="color: #222222" href="' . $file_url . '&dlf">' . PHP_EOL;
