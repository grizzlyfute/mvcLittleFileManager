...
// Catch any error and send to log
set_error_handler(function ($errno, $errstr)
{
  ...
  error_log($errstr);
  // $errstr may need to be escaped if display in html
  // $errstr = htmlspecialchars($errstr);
  // see https://www.php.net/manual/en/errorfunc.constants.php for errno value
